...
1. <font color=yellow>四则表达式</font>
    * 实现方式      
...
4. <font color=yellow>矩阵转置</font>
    ...
    * 测试样例
     ...
     ---
5. <font color=yellow>求矩阵行列式的值</font>
   * 实现方法   
...
2. <font color=yellow>运行函数</font>
   ...
   * 测试样例二
      ...
      * 输出：1.75
    ---
3. <font color=yellow>查看历史函数</font>
   * 实现方法   
   ...
   * 测试样例三
   ...
   ---
4. <font color=yellow>修改历史函数</font>
   * 实现方法   
